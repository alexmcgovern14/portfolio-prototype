...
function IPhone1415Pro() {
  return (
    <div className="absolute h-[160px] left-[43px] pointer-events-none rounded-[16px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] top-[98px] w-[90px]" data-name="iPhone 14 & 15 Pro - 2">
...
function IPhone1415Pro2() {
  return (
    <div className="absolute h-[160px] left-[276px] overflow-clip rounded-[16px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] top-[98px] w-[90px]" data-name="iPhone 14 & 15 Pro - 4">
...
function IPhone1415Pro1() {
  return (
    <div className="absolute h-[184.17px] left-[152.65px] overflow-clip rounded-[16px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] top-[65.8px] w-[103.596px]" data-name="iPhone 14 & 15 Pro - 3">
      <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none rounded-[16px] size-full" src={imgIPhone1415Pro2} />
  ...
  return (
    <div className="relative size-full">
      <div className="flex flex-row justify-center size-full">
        <div className="content-stretch flex gap-[10px] items-start justify-center p-[25px] relative size-full">
          <IPhone1415Pro />
          <IPhone1415Pro2 />
          <IPhone1415Pro1 />
        </div>
